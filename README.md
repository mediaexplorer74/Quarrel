# Quarrel v21.1.1 - dev14393 branch
...
- Min. Win. Os win build (target) set at (to) 14393.
...
## Status
- Draft. 100500 bugs still here.
- PoC. Solution building broken.
- Login-Password auth mode still broken. Discord token change Dialog implemented. 
