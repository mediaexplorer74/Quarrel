...
- iPhone SE LoginPage "emulation" added (old sweet user-agent "mechanics" used), but not operational, sadly! ("White screen" problem because of obsolete EDGE Webview control) 
